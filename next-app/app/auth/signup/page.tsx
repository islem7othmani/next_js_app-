...
function Signup() {
  return (
    ...
    <div className="flex justify-center min-h-screen">
        ...
        <img className='h-screen w-full' src="https://img.freepik.com/free-photo/vertical-shot-guy-with-his-laptop-credit-card-making-payment-online_181624-58691.jpg?t=st=1725707373~exp=1725710973~hmac=3befa5e32ce0ed2c1fb9c03488e190b0a2d49d4b54fe03997fdcc2a273fde3b2&w=360" alt="" />
        </div>
